...
public class EtudiantRestController {
	...
	public List<Etudiant> getEtudiants() {
		return etudiantService.retrieveAllEtudiants(); // Retour direct sans variable temporaire
	}
	...
	// http://localhost:8089/Kaddem/etudiant/affecter-etudiant-departement/1/2
